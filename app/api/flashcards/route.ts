...
export async function POST(request: Request) {
  ...
  function fallback(status = 422) {
    ...
    return Response.json({ error: 'A reliable generated set is not available for this selection. Choose all slides for this lecture, or use the ready-made Quiz 1 practice sets.' }, { status });
  }
