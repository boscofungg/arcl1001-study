...
import './globals.css';
export const metadata:Metadata={title:'Stratum (beta) · ARCL1001',description:'ARCL1001 course readings, AI tutor, flashcards and General practice.',robots:{index:true,follow:true}};
